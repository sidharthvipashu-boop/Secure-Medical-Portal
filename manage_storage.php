...
/**
 * =============================================================================
 *  doctor/view_reports.php  --  All records & reports for one patient
 * =============================================================================
 *  Lists a single patient's medical records (encrypted at rest) and any uploaded
 *  report files (encrypted + federated). From here the doctor can open a record,
 *  add a new one, or upload/download reports.
 * =============================================================================
 */
...
// Load this patient's medical records (we only need metadata for the list;
// the actual decryption happens on the view_record page).
$rstmt = $pdo->prepare(
...
// Load this patient's uploaded reports.
$repStmt = $pdo->prepare(
